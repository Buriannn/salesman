...
if (isset($_POST)) {
		...
		file_put_contents(__DIR__ . '/mailsprem.txt', $_POST['name'].';'.$_POST['email'].';'.$_POST['phone'].';'.$_POST['utm_medium'].';'.$_POST['utm_source'].';'.$_POST['utm_content'].';'.$_POST['utm_group'].';'.$_POST['utm_term'].';'.$_POST['utm_campaign'].';'.$_POST['gcpc'].';'.$_POST['gcao'].';'.$_POST['referer'].';'.date('Y-m-d H:i:s')."\n", FILE_APPEND);
...
//	MAIL
    ...
    $product = 2548866;
    $suma = 14900;
    $productname = "Лучший Продавец в МЛМ";
...
//	GETCOURSE
    ...
    header('Location: sale/zayavkaprem.php?'.$utm.'');
